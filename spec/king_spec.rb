...
describe King do
  ...
  describe '#left_down' do
    context 'when position is nil' do
      it 'should return an empty array' do
        empty_array = []
        expect(king.left_down).to eq(empty_array)
      end
    end

    context 'when a position is assigned' do
      it 'should return the next valid move down left of G2' do
        position = 'G2'
        king.position = position
        moves = %w[F1]
        expect(king.left_down).to eq(moves)
      end
  ...
  describe '#left_up' do
    context 'when position is nil' do
      it 'should return an empty array' do
        empty_array = []
        expect(king.left_up).to eq(empty_array)
      end
    end

    context 'when a position is assigned' do
      it 'should return the next valid move from the left up from C2' do
        position = 'C2'
        king.position = position
        moves = %w[B3]
        expect(king.left_up).to eq(moves)
      end
